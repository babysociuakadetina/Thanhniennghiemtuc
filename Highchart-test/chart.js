(async () => {
  const json = await fetch(
          'https://api.met.no/weatherapi/locationforecast/2.0/compact?lat=21.03333&lon=105.85000'
  ...
  Highcharts.chart('container', {
      ...
      title: {
          text: 'Hourly forecast temperatures in Vietnam',
          align: 'left'
      },
